...
| コース | ダウンロード | インストーラ |
|---|---|---|
| Java 基礎編 | [java-basic-v1.6.4](../../releases/tag/java-basic-v1.6.4) | `chatinable-lite-java-basic-setup-1.6.4.exe` |
| Java 上級編 | [java-advanced-v1.6.4](../../releases/tag/java-advanced-v1.6.4) | `chatinable-lite-java-advanced-setup-1.6.4.exe` |
| Java テスト 基礎＆実践 | [java-testing-v1.6.4](../../releases/tag/java-testing-v1.6.4) | `chatinable-lite-java-testing-setup-1.6.4.exe` |
